/*
 * @Author: ZHouYanWei
 * @Date:   2017-01-16 21:24:56
 * @Last Modified by:   ZHouYanWei
 * @Last Modified time: 2017-01-19 21:36:33
 */

// 定义主题的相关参数
var theme1 = { bg_img: "url(images/bg1.jpg)", theme_color: "#EBC1CB", alter_color: "#EBC1CB", bg_color: "#FDFDF8", font_color: "#48274E", header_text: "#EEF", hover_text_color: "#EBC1CB" };
var theme2 = { bg_img: "url(images/bg2.jpg)", theme_color: "#96C8FF", alter_color: "#96C8FF", bg_color: "#F8FDFD", font_color: "#28272E", header_text: "#EEF", hover_text_color: "#96C8FF" };
var theme3 = { bg_img: "url(images/bg3.jpg)", theme_color: "#0D131E", alter_color: "#BBBBBB", bg_color: "#23293C", font_color: "#B9B9B9", header_text: "#EEF", hover_text_color: "#FFFFFF" };
var theme4 = { bg_img: "url(images/bg4.jpg)", theme_color: "#0D131E", alter_color: "#FF8080", bg_color: "#200000", font_color: "#B9B9B9", header_text: "#EEF", hover_text_color: "#FF8080" };
var theme5 = { bg_img: "url(images/bg5.jpg)", theme_color: "#597307", alter_color: "#9AB647", bg_color: "#F2EDC0", font_color: "#000000", header_text: "#EEF", hover_text_color: "#8DA111" };
var theme6 = { bg_img: "url(images/bg6.jpg)", theme_color: "#A0AFAF", alter_color: "#444444", bg_color: "#FFFFFF", font_color: "#222222", header_text: "#111", hover_text_color: "#707F7F" };
