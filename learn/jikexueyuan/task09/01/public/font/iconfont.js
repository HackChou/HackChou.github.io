;(function(window) {
  ...
  var svgSprite = '<svg>' +
    ...
    '' +
    '<path d="M960 960c0 35.392-28.608 64-64 64s-64-28.608-64-64c0-176.768-143.232-320-320-320-176.704 0-320 143.232-320 320 0 35.392-28.672 64-64 64s-64-28.608-64-64c0-172.864 98.112-322.624 241.536-397.376C236.672 503.936 192 417.6 192 320c0-176.704 143.296-320 320-320 176.768 0 320 143.296 320 320 0 97.6-44.608 183.936-113.536 242.624C861.888 637.376 960 787.136 960 960zM512 128C405.952 128 320 213.952 320 320s85.952 192 192 192c105.984 0 192-85.952 192-192S617.984 128 512 128z"  ></path>' +
    '' +
    '</symbol>' +
    '' +
